...
export function BookingRequestPhoneTimelineDrawer({
  phone,
  open,
  onOpenChange,
  onOpenRequest,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[92vh] max-w-lg overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            {phone ? `All booking requests for ${phone}` : 'Select a phone'}
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-4">
            ...
            {!data.requests.length && (
              <EmptyState
                ...
                description="Create the first booking request for this phone."
              />
            )}
...
/** Prefill state for create dialog opened from phone CRM. */
