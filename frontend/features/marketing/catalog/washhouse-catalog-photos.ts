...
const CATALOG_TILE_BY_KEY: Record<CatalogPhotoKey, `${string}/${string}`> = {
  ...
  shoes_sports: 'household/shoes-sports',
  shoes_leather: 'household/shoes-leather',
  blanket_single: 'household/blanket-single',
  blanket_double: 'household/blanket-double',
  blanket_king: 'household/blanket-king',
  toy_small: 'household/toy-small',
  toy_large: 'household/toy-large',
  toy_medium: 'household/toy-medium',
  ...
  half_jacket_denim: 'winter/half-jacket-cotton-denim',
  jacket_puffer: 'winter/jacket-puffer',
  half_jacket_puffer: 'winter/half-jacket-puffer',
  jacket_leather: 'winter/jacket-leather',
  half_jacket_leather: 'winter/half-jacket-leather',
  winter_cap: 'winter/cap',
  hoodie: 'winter/hoodie',
  shawl: 'winter/shawl',
  bedsheet_single: 'household/bedsheet-single',
  bedsheet_double: 'household/bedsheet-double',
  
  comforter_single: 'household/comforter-single',
  comforter_double: 'household/comforter-double',
  pillow: 'household/pillow-cover',
  
  heels: 'household/heels',
  bag_small: 'household/bag-small',
  bag_large: 'household/bag-large',
  trolley_small: 'household/trolley-small',
  trolley_medium: 'household/trolley-medium',
  trolley_large: 'household/trolley-large',
  carpet_small: 'household/carpet-small',
  carpet_medium: 'household/carpet-medium',
  carpet_large: 'household/carpet-large',
  towel: 'household/towel',
  cotton_gloves: 'household/cotton-gloves',
  leather_gloves: 'household/leather-gloves',
};
...
const CATALOG_PHOTO_ALTS: Record<CatalogPhotoKey, string> = {
  ...
  winter_cap: "Men's winter cap after professional cleaning",
  turban: "turban",
  ...
  half_jacket_denim: 'Cotton denim jacket on a hanger after dry clean and press',
  half_jacket_puffer: 'Quilted puffer jacket hanging after winter dry cleaning',
  half_jacket_leather: 'Leather jacket laid flat after specialist leather care',
  hoodie: 'Hooded sweatshirt after wash and press',
  shawl: 'Soft wool shawl after gentle dry cleaning',
  bedsheet_single: 'Crisp white bedsheets stacked after household laundry',
  bedsheet_double: 'Crisp white bedsheets stacked after household laundry',
  blanket_single: 'Folded blanket after household laundry care',
  blanket_double: 'Folded blanket after household laundry care',
  blanket_king: 'Folded blanket after household laundry care',
  comforter_single: 'Comforter after professional cleaning and fluffing',
  comforter_double: 'Comforter after professional cleaning and fluffing',
  pillow: 'Pillow and cushion covers after wash',
  shoes: 'Sneakers staged after specialist shoe cleaning and deodorizing',
  shoes_sports: 'Sneakers staged after specialist shoe cleaning and deodorizing',
  shoes_leather: 'Sneakers staged after specialist shoe cleaning and deodorizing',
  shoes_bag: 'Clean, deodorise, and refresh your favourite pairs and bags',
  heels: "Women's heels after professional cleaning",
  bag_small: 'Travel backpack after cleaning service',
  bag_large: 'Travel backpack after cleaning service',
  trolley_small: 'Trolley luggage after professional cleaning',
  trolley_medium: 'Trolley luggage after professional cleaning',
  trolley_large: 'Trolley luggage after professional cleaning',
  carpet_small: 'Area carpet after household deep cleaning',
  carpet_medium: 'Area carpet after household deep cleaning',
  carpet_large: 'Area carpet after household deep cleaning',
  towel: 'Bath towels stacked after laundry',
  toy_small: "Children's soft toy after gentle cleaning",
  toy_medium: "Children's soft toy after gentle cleaning",
  toy_large: "Children's soft toy after gentle cleaning",
  cotton_gloves: 'Gloves after specialist cleaning',
  leather_gloves: 'Gloves after specialist cleaning',
...
> = {
  ...
  household: WASHHOUSE_CATALOG_PHOTOS.bedsheet_double,
};
