...
export function washhouseSuggestedFromItems(): MarketplaceFromItem[] {
  ...
  const men: [string, string, number, number | null][] = [
    ['men-shirt-tshirt', 'Shirt / T-shirt', 69, 12],
    ['men-trouser-jeans', 'Trouser / Jeans', 79, 12],
    ['men-lower', 'Lower', 69, 12],
    ['men-jogger-cargo', 'Jogger / Cargo', 79, 12],
    ['men-shorts', 'Shorts', 59, 12],
    ['men-dhoti-lungi', 'Dhoti / Lungi', 79, 19],
    ['men-kurta', 'Kurta', 79, 12],
    ['men-cap-fabric', 'Cap (Fabric)', 29, null],
    ['men-cap-leather', 'Cap (Leather)', 59, null],
    ['men-turban', 'Turban', 79, 29],
    ['men-sherwani-cotton', 'Sherwani (Cotton)', 299, 29],
    ['men-sherwani-wedding', 'Sherwani (Wedding)', 499, 99],
    ['men-coat-formal', 'Coat (Formal)', 179, 25],
    ['men-coat-heavy', 'Coat (Heavy)', 199, 49],
    ['men-suit-2pcs', 'Suit 2 pcs', 249, 39],
    ['men-suit-3pcs', 'Suit 3 pcs', 299, 49],
    ['men-vest', 'Vest', 39, 15],
  ...
  const householdSingle: [string, string, number][] = [
    ...
    ['household-carpet-s', 'Carpet Per Square Foot', 29],

    ['household-comforter-single', 'Comforter (Single)', 299],
    ['household-comforter-double', 'Comforter (Double)', 399],

    ['household-gloves-cotton', 'Cotton Gloves', 39],
    ['household-gloves-leather', 'Leather Gloves', 89],
    
    ['household-pillow-cushion-cover', 'Pillow / Cushion Cover', 39],
    ['household-shoes-sports', 'Shoes (sports)', 249],
    ['household-shoes-leather', 'Shoes (leather)', 349],
    ['household-heels', 'Heels', 249],    
