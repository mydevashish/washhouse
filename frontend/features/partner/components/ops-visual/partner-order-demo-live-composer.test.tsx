...
function buildComposerStub(): PartnerWalkInOrderComposer {
  return {
    ...
    handleDiscountValueChange: jest.fn(),
    applyManualDiscount: jest.fn(),
    deliveryType: 'Both',
    setDeliveryType: jest.fn(),
    preferredDeliveryDate: '',
    setPreferredDeliveryDate: jest.fn(),
    pickupChargeOverride: 0,
    setPickupChargeOverride: jest.fn(),
    deliveryChargeOverride: 0,
    setDeliveryChargeOverride: jest.fn(),
    advancePaid: 0,
    setAdvancePaid: jest.fn(),
    paymentMethod: 'Cash',
