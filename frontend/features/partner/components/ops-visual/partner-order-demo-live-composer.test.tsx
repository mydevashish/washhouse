...
function buildComposerStub(): PartnerWalkInOrderComposer {
  return {
    ...
    expressOrder: false,
    setExpressOrder: jest.fn(),
    staffNote: '',
    setStaffNote: jest.fn(),
    gstInvoiceRequested: false,
    setGstInvoiceRequested: jest.fn(),
    notes: '',
    setNotes: jest.fn(),
    expectedReadyAt: '',
    ...
    addressPincode: '',
    setAddressPincode: jest.fn(),
    addressLandmark: '',
    setAddressLandmark: jest.fn(),
    pickupAtLocal: '',
    setPickupAtLocal: jest.fn(),
    deliveryAtLocal: '',
    setDeliveryAtLocal: jest.fn(),
    services: [],
    ...
    createDoorstepMutation: { isPending: false, mutate: jest.fn() } as unknown as PartnerWalkInOrderComposer['createDoorstepMutation'],
    ...
    couponApplied: false,
    setCouponApplied: jest.fn(),
    couponDiscountInr: 0,
    setCouponDiscountInr: jest.fn(),
