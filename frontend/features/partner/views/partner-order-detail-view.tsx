  ...
  return (
    <PartnerContent className="space-y-5">
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <PartnerPanel title="Customer" bodyClassName="space-y-2 p-4 text-sm">
          <div className="flex flex-wrap items-center gap-2">
      ...
      <div className="grid gap-4 lg:grid-cols-[1fr_280px]">
        <PartnerPanel title="Items" bodyClassName="p-0">
          {order.items.length === 0 ? (
            <p className="px-4 py-6 text-center text-sm text-muted-foreground">No line items.</p>
          ) : (
        ...
        <PartnerPanel title="Totals" bodyClassName="space-y-2 p-4 text-sm">
      ...
      <PartnerPanel title="Order status" bodyClassName="p-4">
