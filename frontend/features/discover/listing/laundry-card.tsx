...
import { getComparePriceLines, comparePriceAriaSummary } from '@/features/discover/lib/compare-price-lines';
  ...
  return (
    ...
    >
      ...
      <CardContent className="flex flex-1 flex-col gap-2.5 p-4">
        <div>
          <h3 className="card-title group-hover:text-primary">{laundry.name}</h3>
