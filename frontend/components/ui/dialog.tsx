...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      'overlay-scrim fixed inset-0 z-50 backdrop-blur-sm',
  ...
  <DialogPortal>
    ...
    >
      ...
      <DialogPrimitive.Close
        className={cn(
          'absolute right-4 top-4 rounded-lg p-1.5 text-muted-foreground opacity-70',
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn('section-title leading-snug tracking-tight', className)}
    {...props}
  />
));
