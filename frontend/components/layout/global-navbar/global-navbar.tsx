...
export function GlobalNavbar({
  ...
  return (
    <NavbarCommandSearchRoot app={app}>
      <header
        className={cn(
          'sticky top-0 z-50 w-full min-w-0 shrink-0 border-b border-border/80 bg-background/90 shadow-sm backdrop-blur-md supports-[backdrop-filter]:bg-background/75',
          className,
        )}
      >
        <div className="flex h-nav w-full min-w-0 items-center gap-1 overflow-x-clip px-2 sm:px-2.5">
          {/* Left */}
