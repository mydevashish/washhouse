...
function AdaptiveFullLogo({
  ...
  return (
    <span
      className={cn(
        compact
          ? 'inline-flex h-6 max-h-[calc(var(--nav-height)-1rem)] shrink-0 items-center sm:h-7 lg:h-7 xl:h-8'
          : 'inline-flex h-7 max-h-[calc(var(--nav-height)-1rem)] shrink-0 items-center sm:h-8 lg:h-9 xl:h-12',
        className,
      )}
    >
      ...
      <Image
        ...
        className={cn(
          'hidden w-auto max-w-[7rem] shrink-0 sm:block sm:max-w-[8rem] lg:hidden',
          objectContain,
      ...
      <Image
        ...
        className={cn(
          'hidden w-auto max-w-[8.5rem] shrink-0 lg:block xl:max-w-[10rem]',
          objectContain,
          compact ? 'h-7 xl:h-8' : 'h-9 xl:h-12',
        )}
      />
    </span>
  );
