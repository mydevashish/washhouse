...
export default function LoginPage() {
  ...
  const showStaffPortalLink = audience === 'partner' || audience === 'admin';
  const nextForLinks = safeNextPath(searchParams.get('next'));
  const registerFooterHref =
    audienceCopy.footerHref === '/register' && nextForLinks
      ? `/register?next=${encodeURIComponent(nextForLinks)}`
      : audienceCopy.footerHref;
  ...
  return (
    <div aria-busy={loading || undefined}>
      <AuthFormCard
        ...
        footer={
          <>
            {audienceCopy.footerPrompt && registerFooterHref && audienceCopy.footerLinkText ? (
              <AuthFooterLink
                prompt={audienceCopy.footerPrompt}
                href={registerFooterHref}
